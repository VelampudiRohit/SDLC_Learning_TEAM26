...
* @author Koduri Rohitha
* @brief program of RockPaperScissors game
* @version 0.1
* @date 2021-07-05
*
...
#include "games.h"
/**
 * @brief functions that are part of the RockPaperScissors
 * 
 */
void game(void);
void plAgain(void);
...
/**
 * @brief main function of RockPaperScissors
 * 
 * @return int 
 */
int mainofRPS(void) {
...
/**
 * @brief Function that declares no of wins and loses
 * 
 */
void game(void) {
  ...
  // variables for setting RockPaperScissors game
...
/**
 * @brief Function that asks whether the user wants to play again or not
 * 
 */
void plAgain(void) {
